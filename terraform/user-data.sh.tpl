...
# Adjust memory limit on nitro-enclaves-allocator
sed -i 's/memory_mib:.*/memory_mib: ${enclaveMemorySize}/' /etc/nitro_enclaves/allocator.yaml
systemctl restart nitro-enclaves-allocator.service

# Run enclave
nitro-cli run-enclave --cpu-count 2 --memory ${enclaveMemorySize} --enclave-name test --enclave-cid 7777 --eif-path /root/enclave.eif
